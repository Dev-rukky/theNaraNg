...
export const AmberButton = forwardRef<HTMLButtonElement, BtnProps>(
...
export function OddsBar({
  ...
  return (
    <div
      className={cn(
        "h-1.5 w-full overflow-hidden rounded-full bg-nara-surface2",
        className,
      )}
      role="progressbar"
      aria-valuemin={0}
    ...
    >
      <div
        className={cn(
          "h-full origin-left rounded-full transition-[width] duration-700",
          color,
        )}
